        ...
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]  '>
                <div className='flex items-center justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                    ...
                    <p className='text-[19px] md:text-[20px] text-[black] '>DoShopAI</p>

                </div>
                <p className='text-[15px] text-[#1e2223] hidden md:block'>DoShopAI is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, and fast delivery—all backed by trusted service designed to make your life easier every day.</p>
            ...
            <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <div className='md:w-[25%] w-[40%]  h-[100%] flex items-center justify-center flex-col text-center '>
                     ...
                     <ul>
                         <li className='text-[15px] text-[#1e2223] '>+91-8602406003</li>
                        <li className='text-[15px] text-[#1e2223] '>ankush321nayak.com</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>+1-123-456-7890</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>admin@DoShopAI.com</li>
                    </ul>
                </div>

        </div>
        <div className='w-[100%] h-[1px] bg-slate-400'></div>
        <div className='w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright AnkushNayak1310-All Rights Reserved</div>
